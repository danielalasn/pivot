...
# index.py
import dash
from dash import dcc, html, Input, Output, State, ctx, callback, clientside_callback, ClientsideFunction
...
# ------------------------------------------------------------------------------
# 9. CLIENTSIDE CALLBACK: DETECCIÓN AUTOMÁTICA DE TEMA (SISTEMA)
# ------------------------------------------------------------------------------
clientside_callback(
    ClientsideFunction(
        namespace='clientside',
        function_name='switch_theme'
    ),
    Output("url", "hash"), # Output dummy
    Input("url", "pathname") # Se ejecuta al cargar
)    
